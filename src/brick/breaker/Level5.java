 ...
 * @author GaUrAv
 */
public class Level5 extends JPanel implements KeyListener, ActionListener{
    ...
    public Level5(int row, int col,int delay,int score){
        this.row = row;
        this.col = col;
        this.delay = delay;
        this.score = score;
        this.totalBrick = row*col*3;
        map = new MapG5(row, col);
        addKeyListener(this);
        setFocusable(true);
    ...
    public void paint(Graphics g){
        ...
        if(totalBrick<=0){
            ...
            g.drawString("You'r Win, Score: "+score, 190, 300);
            g.setColor(Color.WHITE);
