...
public class GamePlay extends JPanel implements KeyListener, ActionListener{
    ...
    public GamePlay(int row, int col, int delay, int score){
        this.row = row;
        this.col = col;
        this.f= true;
        this.maxScore = -1;
    ...
    public void paint(Graphics g){
        ...
        if(ballposY>600){
            ...
            if(!play && f)
            {
                maxScore = (new Sql()).high(score);
                g.setFont(new Font("serif",Font.BOLD,35));
                System.out.println("max: "+maxScore);
                g.drawString("MaxScore: "+maxScore,220,380);
                System.out.println("max: "+maxScore);
                f=false;
            }else
            {
                    ...
                    if(map.map[i][j]>0){
                        ...
                        if(ballRect.intersects(brickRect)){
                            ...
                            if(totalBrick<=0){
                                ...
                                row++;
                                col++;
                                Level2 l2 = new Level2(row,col,score,delay--);
