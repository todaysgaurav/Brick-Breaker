 ...
 * @author GaUrAv
 */
public class Level4 extends JPanel implements KeyListener, ActionListener{
    ...
    public Level4(int row, int col,int delay,int score){
        this.row = row;
        this.col = col;
        this.delay = delay;
        this.score = score;
        this.totalBrick = row*col*2;
        map = new MapG4(row, col);
        addKeyListener(this);
        setFocusable(true);
                    ...
                    if(map.map[i][j]>0){
                        ...
                        if(ballRect.intersects(brickRect)){
                            ...
                            if(totalBrick<=0){
                                JFrame obj = new JFrame();
                                delay--;
                                Level5 l5 = new Level5(row,col,delay,score);
                                obj.setBounds(10,10,700, 600);
                                obj.setBackground(Color.LIGHT_GRAY);
                                obj.setTitle("Brick Breaker");
                                obj.setVisible(true);
